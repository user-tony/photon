                ...
                <div class="form-window-login">
                    <div class="form-window-login-logo">
                        <div class="login-logo">
                            <img src="http://photonui.orangehilldev.com/images/photon/plugins/elrte/js/bootstrap/css/css_compiled/images/photon/js/plugins/images/photon/login-logo@2x.png" alt="Photon UI"/>
                        </div>
