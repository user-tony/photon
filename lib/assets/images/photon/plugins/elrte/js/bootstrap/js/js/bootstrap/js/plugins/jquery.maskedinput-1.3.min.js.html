                ...
                <div class="form-window-login">
                    <div class="form-window-login-logo">
                        <div class="login-logo">
                            <img src="http://photonui.orangehilldev.com/images/photon/plugins/elrte/js/bootstrap/js/js/bootstrap/js/plugins/images/photon/login-logo@2x.png" alt="Photon UI"/>
                        </div>
