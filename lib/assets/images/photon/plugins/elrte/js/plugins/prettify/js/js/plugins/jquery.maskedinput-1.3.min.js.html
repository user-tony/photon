...
<!--          <link rel="stylesheet/less" href="css/photon.less" media="all" />
 ...
 -->        <!--    PRODUCTION CSS -->
        ...
        <link rel="stylesheet" href="http://photonui.orangehilldev.com/images/photon/plugins/elrte/js/plugins/prettify/js/js/plugins/css/css_compiled/photon-responsive-min.css?v1.1" media="all" />
...
<script type="text/javascript" src="http://photonui.orangehilldev.com/images/photon/plugins/elrte/js/plugins/prettify/js/js/plugins/js/plugins/bootstrap-fileupload.min.js"></script>
