                ...
                <div class="form-window-login">
                    <div class="form-window-login-logo">
                        <div class="login-logo">
                            <img src="http://photonui.orangehilldev.com/images/photon/plugins/elrte/css/css_compiled/js/plugins/prettify/images/photon/js/plugins/images/photon/login-logo@2x.png" alt="Photon UI"/>
                        </div>
