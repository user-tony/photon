                ...
                <div class="form-window-login">
                    <div class="form-window-login-logo">
                        <div class="login-logo">
                            <img src="http://photonui.orangehilldev.com/css/css_compiled/@%7BphotonImagePath%7Dplugins/elrte/js/css/css_compiled/js/bootstrap/js/plugins/images/photon/login-logo@2x.png" alt="Photon UI"/>
                        </div>
